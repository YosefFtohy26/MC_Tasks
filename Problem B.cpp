...
int main()
{
    ...
    int a,b,c,d;
    cin>>a>>b>>c>>d;
    int number_of_256 = min(a,min(c,d));
    a-=number_of_256;
    int number_of_32 = min(a,b);
    int total;
    // for (int i = 0;i<number_of_256;i++)
    // {
    //     total+=256;
    // }
    // for (int i = 0;i<number_of_32;i++)
    // {
    //     total+=32;
    // }
    total = (number_of_256 * 256)+(number_of_32 * 32);
    cout<<total;
